...
class OurDatabase {
  ...
  Future<String> createGroup(String groupName, userUid, initialBook) async {
    String retVal = "error";
  ...
  Future<String> finishedBook(
      String groupId, bookId, uid, int rating, String review) async {
    String retVal = "error";
  ...
  Future<bool> isUserDoneWithBook(String groupId, bookId, uid) async {
    bool retVal = false;
    try {
      DocumentSnapshot _docSnapShot = await _firestore
          .collection("groups")
